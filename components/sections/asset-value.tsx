    ...
    <section id="asset-value" className="relative scroll-mt-32 overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-x-0 top-0 z-10 pt-12 md:pt-20 lg:pt-24">
        <div className="mx-auto max-w-7xl px-4">
          ...
          >
            <p className="md:text-lg leading-relaxed" style={{ fontFamily: '"游明朝", "Yu Mincho", "Hiragino Mincho Pro", serif', fontSize: '1.1rem', color: '#8b2a4a' }}>
              &ldquo;泉&rdquo;は、将来的に人が集まる場所へ
            </p>
            <p className="md:text-lg leading-relaxed mb-6" style={{ fontFamily: '"游明朝", "Yu Mincho", "Hiragino Mincho Pro", serif', fontSize: '1.1rem', color: '#8b2a4a' }}>
              資産価値としての可能性
            </p>
            <h2 className="text-4xl md:text-6xl lg:text-7xl tracking-[0.08em]" style={{ fontFamily: '"游明朝", "Yu Mincho", "Hiragino Mincho Pro", serif', color: '#8b2a4a' }}>
              ASSET VALUE
            </h2>
          </motion.div>
