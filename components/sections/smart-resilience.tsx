...
const CARDS = [
  ...
  },
  {
    ...
    image: "/images/smart-hems.webp",
    alt: "スマートハイムナビでエネルギーを管理するタブレット画面",
    description:
      "スマートハイムナビ（HEMS）でエネルギー設備を一元管理し、自宅電力を「見える化」。さらに、家じゅうの機器※1※2とつながり、音声操作や遠隔操作など毎日の安心・快適・便利をお手伝いします。※1)新スマートハイムナビ対応の機種のみ連携可能です。※2)新スマートハイムナビ対応のエコキュートが対象です。",
  },
  {
    title: "停電に備える",
    image: "/images/smart-battery.webp",
  ...
  {
    title: "高断熱で暮らす",
    image: "/images/smart-insulation.webp",
  ...
  {
    title: "地震に備える",
    image: "/images/smart-earthquake.webp",
